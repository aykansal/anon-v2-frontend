...
export function Builder() {
  ...
  return (
    <div classNameName="h-screen relative bg-gray-600  flex flex-col">
      
      <div classNameName={`absolute w-full  z-30 h-screen ${chat ?"block" : "hidden"} bg-black/10 backdrop-blur-sm flex items-center justify-center`}>
