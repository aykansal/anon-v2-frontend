         ...
         <A0_button  bg={"#A6E433"}  border={false} content={"Connect wallet"} size={"150"}/>
              ...
              <div className='w-full relative h-[86%] pt-[75px] '>
                ...
                <div className='w-full flex flex-col items-center'>
                  ...
                  <div className=' w-[19%] h-9 bg-gradient-to-r flex items-center justify-center from-purple-400 tracking-wide  to-pink-400  gradient-animation text-neutral-950 font-semibold rounded-full'>
              ...
              placeholder="Describe the website you want to build..." className='outline-none bg-transparent flex-1' type="text" placeholder='Enter Product Description here' />
