         ...
         <A0_button bg={"#A6E433"}  border={false} content={"Sign up"}/>
              ...
              <div className='w-full h-[86%] '>
                ...
                <div className='w-full flex flex-col items-center'>
                  ...
                  <div className=' w-[20%] h-9 bg-gradient-to-r flex items-center justify-center from-purple-400 tracking-wider to-pink-400 text-neutral-950 font-semibold rounded-full'>
