...
const Landing = () => {
  ...
  return (
    ...
    <div className='w-full h-screen bg-black py-8 f5'>
      ...
      <div className='w-[60%] flex items-center h-[9%] rounded-full border-white/30 border-[1px] mx-auto '>
        ...
        <div>
          <button className='w-16 h-10 border-[1px] border-white/50 rounded-full'>sign up</button>
        </div>
