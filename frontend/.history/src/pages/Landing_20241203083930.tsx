...
{/* this is the third section  */}
              ...
              <div className='w-[70%] text-center mt-10 mx-auto text-[5rem] leading-none tracking-tighter'><p>Your creative process deserves better. You're racing to create exceptional work but, traditional design tool slow you down with unnecessary complexity and steep learning curves. <br /> <span>That's why we built layers.</span> </p></div>
              </div>
