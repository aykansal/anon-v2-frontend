...
export function Builder() {
  ...
  <PreviewFrame webContainer={webcontainer} files={files} />
              ...
              <div className="rounded-xl p-1 w-[30%] bg-white  h-full ">
                ...
                <div className='w-full flex justify-start gap-2 mb-5 items-start '>
                  <div className='w-10 h-10 rounded-full bg-[#a6e433]'></div>
                  <div className='mt-2 w-[60%] py-5 px-3 rounded-lg rounded-tl-none bg-[#E2E8F0] '>
                ...
                <div className='w-full flex justify-end gap-2 items-start '>
                
                  <div className='mt-2 w-[60%] py-5 px-3 rounded-lg rounded-tr-none bg-[#E2E8F0] '>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis sit nulla quas ratione id doloribus nostrum iusto minus. Quibusdam, dolorum!</p>
                  </div>
                  <div className='w-10 h-10 rounded-full bg-[#a6e433]'></div>
                </div>
