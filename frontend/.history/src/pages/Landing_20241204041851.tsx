  ...
  return (
    <main className='relative'>
      <Spline
        ...
        <svg width="10" height="10" fill="none" id="svg2097040886_406"><path fill-rule="evenodd" clip-rule="evenodd" d="M9 64a8 8 0 0 1-8-8V16.196a8 8 0 0 1 2.443-5.755l8.487-8.196A8 8 0 0 1 17.487 0H27v64H9Z" fill="#1B1B1C"></path><path d="M27 63.5H9c-4.393 0-7.559-3.533-7.602-7.92L1 17.079A7.995 7.995 0 0 1 3.492 11.2L11.919 3C13.408 1.587 15.384.5 17.438.5H27" stroke="#fff" stroke-opacity=".12"></path></svg>
<svg width="100" height="168" fill="none" id="svg-1365731993_178"><path d="M2 40.828 40.828 2H392v125.164L352.679 166H2V40.828Z" stroke="#fff" stroke-width="4"></path></svg>
        </div>
