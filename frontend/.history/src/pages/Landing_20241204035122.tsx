  ...
  return (
    <main className='relative'>
      <Spline
        ...
        <div className='absolute py-3 px-5 w-full h-screen top-0 left-0 z-10 pointer-events-none '>

          <nav className='w-full bg-[#000]/70 rounded-tl-3xl  rounded-br-3xl  backdrop-blur-md h-[10%] flex'>
          <svg className="w-[100%] h-[100%]" viewBox="0 0 27 64" preserveAspectRatio="none" width="100%" height="100%"><use href="#svg2097040886_406"></use></svg>
          </nav>
        </div>
