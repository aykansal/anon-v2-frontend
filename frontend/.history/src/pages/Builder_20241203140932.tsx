...
export function Builder() {
  ...
  return (
    <div className="h-screen relative bg-gray-600 relative flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full grid grid-cols-3 gap-6 p-6">
          ...
          <div className="col-span-2 w-[100%] absolute left-[10%] bg-gray-900 rounded-lg shadow-lg p-4 h-[calc(100vh-8rem)]">
