...
{/* this is the third section  */}
              ...
              <div className='w-[60%] text-center mt-10 mx-auto text-6xl'><p>Your creative process deserves better. You are racing to create exceptional work but traditional design tool slow you down with unnecessary complexity and steep learning curves. <span>That's why we built layers.</span> </p></div>
              </div>
