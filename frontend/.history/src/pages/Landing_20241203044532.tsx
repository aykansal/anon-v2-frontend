              ...
              <div className='w-full h-[86%] pt-[90px] '>
                ...
                <div className='w-full flex flex-col items-center'>
                  ...
                  <div className='w-full flex justify-center mt-5'>
                    <div className='w-[40%] h-14 border-[1px] flex items-center px-5 border-white/30 rounded-full'>
                      <input className='outline-none bg-transparent' type="text" placeholder='Enter Your Email' />
                      <A0_button bg={"#A6E433"}  border={false} content={"Sign up"}/>
                    </div>
                  </div>
