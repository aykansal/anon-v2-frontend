      ...
      <Spline
        ...
        <div className="border-[1px] text-white f6 text-xs w-[50%] py-3  flex items-center rounded-lg rounded-tl-none rounded-br-none  justify-center uppercase border-white/40  ">
          ...
          <div className="w-full h-[90%] relative ">
            <div className="absolute bottom-44 leading-[5rem] text-7xl f7 text-white  left-10">
              <h1>Impactful desing, </h1>
              <h1>Created Effortlessly</h1>
            </div>
            ...
            <div className="w-full h-[10%] bottom-10 left-10 text-white f7 absolute flex">
                  <div className="w-1/2 flex">
                    <h1 className="opacity-70 text-xl w-[65%]">Idea into Reality with large Language models ,locally and securely.</h1>
                    <div className="w-[15%] -ml-2 mt-3 flex items-center justify-center h-[70%] bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 rounded-lg rounded-tl-none text-black shadow-[inset_0_2px_5px_rgba(255,255,255,0.5),_0_4px_10px_rgba(0,0,0,0.2
