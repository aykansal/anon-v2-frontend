          ...
          <div className="w-full h-[90%] relative ">
            ...
            <div className="w-full h-[10%] bottom-10 left-10 text-white f7 absolute flex">
                  <div className="w-1/2 flex">
                    ...
                    <div className="w-[15%] mt-2 flex items-center justify-center h-[70%] bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 rounded-lg rounded-tl-none text-black shadow-[inset_0_2px_5px_rgba(255,255,255,0.5),_0_4px_10px_rgba(0,0,0,0.2
