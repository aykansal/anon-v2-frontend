...
export function Builder() {
  ...
  return (
    ...
    <div className="h-screen bg-black ">
      ...
      {/* this is the outer flex div */}
        <div className={` ${chat ? "" : "pl-24"} w-full p-2  h-full flex gap-1  transition-all duration-300 `}>
          ...
          <div className={`h-full ${chat ? "w-[20%] " : "w-[25%]"} w-[20%]   overflow-auto`}>
  ...
  <PreviewFrame webContainer={webcontainer} files={files} />
              ...
              <div className={` ${ chat ? "block" : "hidden"} rounded-xl p-1 w-[30%] bg-gray-500  h-full `}>
