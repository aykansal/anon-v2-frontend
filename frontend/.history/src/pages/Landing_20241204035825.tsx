    ...
    <main className='relative'>
      <Spline
        ...
        <div className='absolute py-5 px-6  w-full h-screen top-0 left-0 z-10 pointer-events-none '>
          ...
          <nav className='w-full items-center px-5 border-[1px] border-white/20 rounded bg-[#000]/70 rounded-tl-3xl  rounded-br-3xl  backdrop-blur-md h-[10%] flex'>

          <div className="h-full flex items-center">
            <img className=" h-[35%] object-cover " src="https://framerusercontent.com/images/ILoSYJKzeM4s1bziHjzPRh1hg.webp?scale-down-to=512" alt="logo" />
          </div>
