          ...
          <div className="w-full h-[90%] relative ">
            ...
            <div className="w-full h-[10%] bottom-10 left-10 text-white f7 absolute flex">
                  <div className="w-1/2 flex">
                    ...
                    <div className="w-[15%] flex items-center justify-center h-[70%] bg-white/20 backdrop-blur-md rounded-lg rounded-tl-none text-black shadow-lg border border-white/30">
  <h1>Explore</h1>
</div>
