        ...
        <div className='w-full '>
          <div className='w-[70%] px-20 mx-auto overflow-hidden  flex gap-16 relative'>
            ...
            {/* this contains the marquee images  */}
                ...
                <div className='w-[10%] h-full bg-gradient-to-r from-black via-black backdrop-blur-sm   to-black/30 absolute top-0 left-0'></div>
                </div>
                <div className='w-[10%] h-full bg-gradient-to-l from-black/30  via-black backdrop-blur-sm   to-black absolute top-0 right-0'></div>
                </div>
        </div>
      </div>
