...
export function Builder() {
  ...
  return (
    <div className="h-screen relative bg-gray-600  flex flex-col">
      ...
      <div className={`absolute w-full  z-30 h-screen ${chat ?"block" : "hidden"} bg-black/10 backdrop-blur-sm  flex items-center justify-center`}>
        <div onClick={ChangeChat} className='w-12 absolute bg-black text-white top-10 left-10  h-12 rounded-full flex items-center justify-center'>
          cancle
        </div>
  ...
  <div className="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-lg overflow-hidden">
    ...
    <div className="bg-gray-300 p-4">
      ...
      <div onClick={ChangeChat} className='w-12 text-white text-xl flex items-center justify-center h-12 rounded-full bg-black absolute bottom-5 right-10'>
