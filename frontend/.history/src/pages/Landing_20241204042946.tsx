  ...
  return (
    <main className='relative'>
      <Spline
        ...
        <div className="border-[1px] text-white f6 text-xs w-[50%] py-3  flex items-center rounded-lg rounded-tl-none rounded-br-none  justify-center uppercase border-white  ">
          <h1>Projects</h1>
